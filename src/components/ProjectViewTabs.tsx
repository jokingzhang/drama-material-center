...
import { projectLibraryPath, projectStoryPath } from "../lib/routes";
...
export function ProjectViewTabs({ projectId, active }: { projectId: string; active: "story" | "library" }) {
  return (
    <nav className="project-view-tabs" aria-label="项目视图">
      <Link className={active === "story" ? "active" : ""} to={projectStoryPath(projectId)}><BookOpenText size={17} />剧本</Link>
